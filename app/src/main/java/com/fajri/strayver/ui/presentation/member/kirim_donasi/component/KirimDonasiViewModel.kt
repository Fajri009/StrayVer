...
class KirimDonasiViewModel @Inject constructor(
    ...
    fun donasiBarangSubmit(context: Context, namaDonasi: String, donasiId: String, donasiType:
    String, relawan:
    String) {
        val trans= Transaksi(
            donasiId= donasiId,
        ...
        viewModelScope.launch {
            transaksiRepository.addTransaksi(trans, context, _imageUri.value!!).collect() {
                when(it) {
